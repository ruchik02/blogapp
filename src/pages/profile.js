    ...
    <div className="my-3">
      <div className="bg-white rounded overflow-hidden">
        <div className="text-center p-6  border-b">
          <Image className='h-24 w-24 rounded-full mx-auto' src={session.user.image} alt="user image" width={24} height={24}/>
        ...
        <div className="border-b">
          <a href="#" className="px-4 py-6 hover:bg-gray-100 flex">
        ...
        <div className="">
          <a href="#" className="px-4 py-5 pb-5 hover:bg-gray-100 flex">
          ...
          <a href="/logout" className="px-4 py-5 pb-5 hover:bg-gray-100 flex">
