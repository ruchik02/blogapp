            ...
            <div class="flex flex-col space-y-5">
              ...
              <div class="flex flex-col space-y-4">
                ...
                >
                  ...
                  <span class="text-sm font-medium text-gray-800 group-hover:text-white"  onClick={()=>signIn()}>Github</span>
                </a>
                <a
                  href="#"
                ...
                >
                  ...
                  <span class="text-sm font-medium text-blue-500 group-hover:text-white" onClick={()=>signIn()}>Google</span>
                </a>
              </div>
            </div>
          </form>
