...
const Login = () => {
  ...
  return (
    ...
    <div className="flex items-center min-h-screen p-4 bg-gray-100 lg:justify-center">
      ...
      >
        <div
          className="p-2 py-6 text-white bg-blue-500 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly"
        >
        ...
        <div className="p-5 bg-white md:flex-1">
          ...
          <form action="#" className="flex flex-col space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col space-y-5">
              ...
              <p className='text-md text-center text-blue-600 focus:text-blue-800'>No account? <Link href='/signup'><span className='hover:underline'>create one</span></Link></p>
              <div className="flex flex-col space-y-4">
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-800 group-hover:text-white"  onClick={()=>signIn()}>Github</span>
                </a>
                <a
                  href="#"
                ...
                >
                  ...
                  <span className="text-sm font-medium text-blue-500 group-hover:text-white" onClick={()=>signIn()}>Google</span>
                </a>
              </div>
            </div>
          </form>
